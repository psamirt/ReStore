    ...
    <div className="container">
      <footer className="py-3 my-4">
        <ul className="flex justify-center border-b pb-3 mb-3">
          ...
          <li className="mr-3">
            <a href="/SobreNosotros" className="text-gray-500 hover:text-gray-900">
              Sobre nosotros
            </a>
          </li>
          <li className="mr-3">
            <a href="/RolAmbiental" className="text-gray-500 hover:text-gray-900">
              Rol ambiental
            </a>
          </li>
          <li className="mr-3">
        ...
        <p className="text-center text-gray-500">&copy; 2023 ReEstore, Inc </p>
      </footer>
    </div>
  );
}
